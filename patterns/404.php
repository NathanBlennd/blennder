...
return array(
	'title'      => esc_html__( '404', 'blennder' ),
	'categories' => array( 'text' ),
	'inserter'   => false,
	'content'    => '
		<!-- wp:heading {"className":"is-style-blennder-text-shadow","textAlign":"center","fontSize":"x-large"} -->
		<h2 class="has-text-align-center has-x-large-font-size is-style-blennder-text-shadow">' . __( 'Page not found', 'blennder' ) . '</h2>
		<!-- /wp:heading -->
		<!-- wp:paragraph --><p>' . __( 'It looks like nothing was found at this location. Maybe try a search?', 'blennder' ) . '</p><!-- /wp:paragraph -->
		...
		<h2 class="has-text-align-left">' . __( 'Latest posts', 'blennder' ) . '</h2>
		<!-- /wp:heading -->
